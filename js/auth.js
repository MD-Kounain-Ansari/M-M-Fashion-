...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const authCardBg =
        document.getElementById("authCardBg");
    ...
    const signupHero =
        document.getElementById("authSignupHero");

    const signinHero =
        document.getElementById("authSigninHero");
    ...
    const showSigninBtn =
        document.getElementById("showSigninBtn");
    ...
    function showSignin() {
        ...
        authCardBg?.classList.remove(
            "signup-bg"
        );

        authCardBg?.classList.add(
            "signin-bg"
        );


        signupHero?.classList.remove(
            "active"
        );

        signinHero?.classList.add(
            "active"
        );
    ...
    function showSignup() {
        ...
        signinHero?.classList.remove(
            "active"
        );

        signupHero?.classList.add(
            "active"
        );


        signinPanel?.classList.remove(
            "active"
        );
...
function validateSignupField(field) {
    ...
    if (
        field.id === "signupConfirmPassword"
    ) {
